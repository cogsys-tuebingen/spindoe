...
if __name__ == "__main__":
    ...
    dot_detector_model = Path(
        "/home/gossard/Git/spindoe/python/lightning_logs/version_25/checkpoints/epoch=3-step=880.ckpt"
    )
    ...
    imgs = read_ball_images([img_paths[i] for i in rdm_idx], RGB=False)
